...
def predict_fare(pickup_community_area , trip_start_hour,trip_miles,trip_seconds, dropoff_community_area):
    y_predict = requests.post('http://127.0.0.1:5000/predict',   json=[{"pickup_community_area":pickup_community_area, "trip_start_hour":trip_start_hour,"trip_miles":trip_miles, "trip_seconds":trip_seconds,"dropoff_community_area":dropoff_community_area}],headers={"Content-Type": "application/json"},)
